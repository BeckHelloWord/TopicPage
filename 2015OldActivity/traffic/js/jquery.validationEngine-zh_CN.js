	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"ajaxUsername":{
					url: "http://m.bxjr.cc/secure/valid-username.html",
					//url: "http://localhost:8083/web/secure/valid-username.html",
					alertText: "* 用户名已被使用",
					alertTextLoad: "正在验证中..."
				},
				"ajaxMobile":{
					//url: "http://localhost:8083/web/secure/valid-mobile.html",
					url: "http://m.bxjr.cc/secure/valid-mobile.html",
					alertText: "手机号已被使用",
					alertTextLoad: "正在验证中..."
				}
