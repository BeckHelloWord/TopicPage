(function () {
    ...
    var delay = getQueryString('delay') ? getQueryString('delay') : 10,URI= 'http://g.bxwd.cc/';
var placeList = [
...
$(function(){
    ...
    setInterval(function(){
        ...
        var todayHms = "<span>" + h + "</span><i>:</i><span>" + m + "</span><i>:</i><span>" + s +"</span>";

        $(".today_num .bd").html(todayHms);
    }, 1000);

    $(".today_num .hd").html(todayYmd());
